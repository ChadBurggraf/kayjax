//-----------------------------------------------------------------------
// <copyright file="RouteElementCollection.cs" company="Tasty Codes">
...
namespace Kayson.Configuration
{
    ...
    /// <summary>
    /// Represents a collection of <see cref="RouteElement"/>s in the configuration.
    /// </summary>
    public sealed class RouteElementCollection : ConfigurationElementCollection<RouteElement>
    {
        /// <summary>
        ...
        public override bool Contains(RouteElement item)
        {
            return this.Any(e => e.Pattern == item.Pattern);
        }
